...
import classes from './Btn_ColourAccent2HoverFalse.module.css';
...
/* @figmaId 3:28 */
export const Btn_ColourAccent2HoverFalse: FC<Props> = memo(function Btn_ColourAccent2HoverFalse(props = {}) {
  return (
